...
export default function RootLayout({ children }) {
  // This must be a Client Component to use hooks, so wrap content in a ClientRoot
  return (
    <html lang="en">
...
// ClientRoot is a client component to use DevMode context and render button/modal
"use client";
...
function ClientRoot({ children }) {
  ...
  return (
    <>
      <Navbar />
      <DevModeButton onClick={handleDevButtonClick} visible={isDevUser && !devMode} />
      <DevModeModal open={modalOpen} onClose={handleModalClose} onLogin={handleDevLogin} error={error} />
